...
${OBJECTDIR}/BasicFunctions.o: BasicFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BasicFunctions.o BasicFunctions.cpp

${OBJECTDIR}/BasicTypes.o: BasicTypes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BasicTypes.o BasicTypes.cpp
...
${OBJECTDIR}/Combinatorics.o: Combinatorics.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Combinatorics.o Combinatorics.cpp

${OBJECTDIR}/CompleteKarmarkarKarp.o: CompleteKarmarkarKarp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CompleteKarmarkarKarp.o CompleteKarmarkarKarp.cpp

${OBJECTDIR}/CompleteKarmarkarKarp_MPZ.o: CompleteKarmarkarKarp_MPZ.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CompleteKarmarkarKarp_MPZ.o CompleteKarmarkarKarp_MPZ.cpp

${OBJECTDIR}/Cronometro.o: Cronometro.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Cronometro.o Cronometro.cpp
...
${OBJECTDIR}/HashExtended.o: HashExtended.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HashExtended.o HashExtended.cpp
...
${OBJECTDIR}/HeapStructure.o: HeapStructure.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HeapStructure.o HeapStructure.cpp

${OBJECTDIR}/ListStructure.o: ListStructure.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ListStructure.o ListStructure.cpp

${OBJECTDIR}/ListStructurePtr.o: ListStructurePtr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ListStructurePtr.o ListStructurePtr.cpp

${OBJECTDIR}/Mpz_Heap_Node_Template.o: Mpz_Heap_Node_Template.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Mpz_Heap_Node_Template.o Mpz_Heap_Node_Template.cpp

${OBJECTDIR}/NumberPartitionProblem.o: NumberPartitionProblem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/NumberPartitionProblem.o NumberPartitionProblem.cpp

${OBJECTDIR}/NumberPartitionProblem_MPZ.o: NumberPartitionProblem_MPZ.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/NumberPartitionProblem_MPZ.o NumberPartitionProblem_MPZ.cpp

${OBJECTDIR}/PPN_Heap.o: PPN_Heap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/PPN_Heap.o PPN_Heap.cpp
